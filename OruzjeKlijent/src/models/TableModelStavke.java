...
public class TableModelStavke extends AbstractTableModel {
    ...
    private String[] kolone = {"Rb", "Oruzje", "Kolicina", "Cena"};
    private int rb = 0;
    ...
    public Object getValueAt(int row, int column) {
        ...
        switch (column) {
            ...
            case 1:
                return sn.getOruzje().getNazivOruzja();
            case 2:
    ...
    public void dodajStavku(StavkaNarudzbine sn) {
        ...
        for (StavkaNarudzbine stavkaNarudzbine : lista) {
            if(stavkaNarudzbine.getOruzje().getOruzjeID().equals(sn.getOruzje().getOruzjeID())){
