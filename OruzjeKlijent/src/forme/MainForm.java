...
import FormOruzje.FormNovoOruzje;
import FormOruzje.FormPretragaOruzja;
...
public class MainForm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        cmbOruzje = new javax.swing.JComboBox();
        ...
        miNovoOruzje = new javax.swing.JMenuItem();
        miPretragaOruzja = new javax.swing.JMenuItem();
        ...
        txtDatumIsporuke.setText("30.09.2023");

        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder("Unos stavki narudzbine"));

        jLabel4.setText("Oruzje:");

        jLabel5.setText("Kolicina:");

        jLabel6.setText("Cena (€):");

        cmbOruzje.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));
        cmbOruzje.addItemListener(new java.awt.event.ItemListener() {
            public void itemStateChanged(java.awt.event.ItemEvent evt) {
                cmbOruzjeItemStateChanged(evt);
            }
        });
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                        .addComponent(cmbOruzje, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        ...
        jPanel3Layout.setVerticalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel4)
                    .addComponent(cmbOruzje, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel5)
        ...
        jMenu6.setText("Oruzje");

        miNovoOruzje.setText("Novo oruzje");
        miNovoOruzje.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                miNovoOruzjeActionPerformed(evt);
            }
        });
        jMenu6.add(miNovoOruzje);

        miPretragaOruzja.setText("Pretraga oruzja");
        miPretragaOruzja.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                miPretragaOruzjaActionPerformed(evt);
            }
        });
        jMenu6.add(miPretragaOruzja);
    ...
    private void miNovoOruzjeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_miNovoOruzjeActionPerformed
        new FormNovoOruzje(this, true).setVisible(true);
    }//GEN-LAST:event_miNovoOruzjeActionPerformed

    private void miPretragaOruzjaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_miPretragaOruzjaActionPerformed
        new FormPretragaOruzja(this, true).setVisible(true);
    }//GEN-LAST:event_miPretragaOruzjaActionPerformed
    ...
    private void txtKolicinaKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtKolicinaKeyReleased
        ...
        if (evt.getKeyChar() >= '0' && evt.getKeyChar() <= '9') {
            ...
            Oruzje o = (Oruzje) cmbOruzje.getSelectedItem();
    ...
    private void cmbOruzjeItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_cmbOruzjeItemStateChanged

        if (cmbOruzje.getSelectedItem() != null) {
            if (txtKolicina.getText().isEmpty()) {
                txtCena.setText("");
                return;
            }
    ...
    }//GEN-LAST:event_cmbOruzjeItemStateChanged
...
//            Logger.getLogger(MainForm.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private javax.swing.JComboBox cmbOruzje;
    ...
    private javax.swing.JMenuItem miNovoOruzje;
    private javax.swing.JMenuItem miOdjava;
    private javax.swing.JMenuItem miPretragaOruzja;
    ...
    public void popuniOruzja() {
        try {
            ArrayList<Oruzje> oruzja = ClientController.getInstance().getAllOruzje();

            cmbOruzje.removeAllItems();

            for (Oruzje oruzje : oruzja) {
                cmbOruzje.addItem(oruzje);
            }
